...
namespace pkmcom{
  ...
  class BadEnumValue final:ProtocolError{
  public:
    ~BadEnumValue()=default;
    pkm_json getErrorTextComponent();
  };

  class InvalidPacket final:ProtocolError{
  public:
    ~InvalidPacket()=default;
    pkm_json getErrorTextComponent();
  };
  class MalformedPacket final:ProtocolError{
  private:
    pkm_json msg;
  public:
  ...
  template<> struct pkm_traits<pkm_boolean>{
      ...
      constexpr static pkm_int hashcode(pkm_boolean b){
          return b?1337:1331;
      }
      constexpr static pkm_uint size(pkm_boolean b){
          return 1;
      }
  };
  ...
  template<> struct pkm_traits<pkm_byte>{
      ...
      constexpr static pkm_int hashcode(pkm_byte b){
          return int(b)&0xff;
      }
      constexpr static pkm_uint size(pkm_byte b){
          return 1;
      }
  ...
  template<> struct pkm_traits<pkm_sbyte>{
      ...
      constexpr static pkm_int hashcode(pkm_sbyte b){
          return int(b)&0xff|((b&0x80==0)?0:0xffffff00);
      }
      constexpr static pkm_uint size(pkm_sbyte b){
          return 1;
      }
  ...
  template<> struct pkm_traits<pkm_short>{
      ...
      constexpr static pkm_int hashcode(pkm_short b){
          return int(b)&0xffff|((b&0x8000==0)?0:0xffff0000);
      }
      constexpr static pkm_uint size(pkm_short b){
          return 2;
      }
  ...
  template<> struct pkm_traits<pkm_ushort>{
      ...
      constexpr static pkm_int hashcode(pkm_ushort b){
          return int(b)&0xffff;
      }
      constexpr static pkm_uint size(pkm_ushort b){
          return 2;
      }
  ...
  template<> struct pkm_traits<pkm_int>{
      ...
      constexpr static pkm_int hashcode(pkm_int i){
          return i;
      }
      constexpr static pkm_uint size(pkm_int b){
          return 4;
      }
  ...
  template<> struct pkm_traits<pkm_uint>{
      typedef pkm_int& read_type;
      typedef pkm_int write_type;
      constexpr static pkm_int hashcode(pkm_uint i){
          return int(i);
      }
      constexpr static pkm_uint size(pkm_uint b){
          return 4;
      }
  };
  ...
  template<> struct pkm_traits<pkm_long>{
      ...
      constexpr static pkm_int hashcode(pkm_long l){
          return (l>>32LL)^int(l);
      }
      constexpr static pkm_uint size(pkm_long l){
          return 8;
      }
  ...
  template<> struct pkm_traits<pkm_string>{
      ...
      inline static pkm_int hashcode(const pkm_string& str){
          ...
          for(char c:str){
              hash *= prime;
              hash += pkm_trait<pkm_sbyte>::hashcode(c);
          }
          return hash;
      }
  ...
  template<> struct pkm_traits<pkm_instant>{
      ...
      constexpr static pkm_int hashcode(const pkm_instant& i){
      ...
      constexpr static pkm_uint size(const pkm_instant& i){
          return 12;
      }
  };
  template<> struct pkm_traits<pkm_duration>{
      ...
      constexpr static pkm_int hashcode(const pkm_duration& i){
          pkm_long seconds = i.toEpochSecond();
          pkm_int nanos = i.getNanos();
          return pkm_traits<pkm_long>::hashcode(seconds)*31+pkm_traits<pkm_int>::hashcode(nanos);
      }
      constexpr static pkm_uint size(const pkm_duration& i){
          return 12;
      }
  };

  template<typename E,typename UType=typename std::underlying_type<E>::type,typename UTraits=pkm_traits<UType>> struct pkm_traits<E>{
      typedef UType underlying_type;
      typedef UTraits underlying_traits;
      typedef E& read_type;
      typedef E write_type;
      constexpr static pkm_int hashcode(E e){
          union{
              E e1;
              underlying_type underlying;
          };
          e1 = e;
          return underlying_traits::hashcode(underlying);
      }
      constexpr static pkm_uint size(E e){
          union{
              E e1;
              underlying_type underlying;
          };
          e1 = e;
          return underlying_traits::size(underlying);
      } 
  };
  ...
  template<> struct pkm_traits<pkm_uuid>{
      ...
      constexpr static pkm_int hashcode(const pkm_uuid& u){
  ...
  template<> struct pkm_traits<pkm_version>{
      ...
      constexpr static pkm_int hashcode(pkm_version v){
  ...
  template<> struct pkm_traits<pkm_float>{
      ...
      constexpr static pkm_int hashcode(pkm_float f){
          union{
              pkm_float f1;
              pkm_int bits;
          };
  ...
  template<> struct pkm_traits<pkm_double>{
      ...
      constexpr static pkm_int hashcode(pkm_double f){
          union{
              pkm_double f1;
              pkm_long bits;
          };
          f1 = f;
          return pkm_traits<pkm_long>::hashcode(bits);
      }
      constexpr static pkm_uint size(pkm_double d){
          return 8;
      }
  };
  ...
  struct pkm_longjson{
  public:
      JsonValue underlying;
      pkm_longjson(const JsonValue&);
      pkm_longjson(JsonValue&&);
  ...
  template<> struct pkm_traits<pkm_longjson>{
      ...
      inline static pkm_uint size(const pkm_longjson& val){
          pkm_string str = val.underlying.asString();
          return pkm_traits<pkm_string>::size(str);
      }
  ...
  template<typename T,typename void_type=std::void_t<std::integral_constant<pkm_byte,T::id>,
  decltype(std::declval<T>().read(declval<PacketBuffer&>())),decltype(std::declval<const T>().write(std::declval<PacketBuffer&>())),
  decltype(std::declval<const T>().hashcode()),decltype(std::declval<const T>().size()>> 
      struct is_packet<T,void_type>:true_type{};

  template<typename T,typename void_type=typename std::enable_if<is_packet<T>::value>::type> struct pkm_traits{
  ...
  template<typename T,typename void_type=typename std::enable_if<is_packet<T>::value>::type> 
      PacketBuffer& operator>>(PacketBuffer& buff,pkm_traits<T>::read_type packet){
          packet.read(buff);
          return buff;
      }
 template<typename T,typename void_type=typename std::enable_if<is_packet<T>::value>::type>
  ...
  private:
      ...
      pkm_json player;
  public:
      constexpr static pkm_byte id = 0;
      pkm_int hashcode()const;
      pkm_uint size()const;
  ...
  public:
      constexpr static pkm_byte id = 1;
      pkm_int hashcode()const;
      pkm_uint size()const;
      void read(PacketBuffer&);
      void write(PacketBuffer&)const;
  ...
  private:
      pkm_json reason;
  public:
      constexpr static pkm_byte id = 2;
      pkm_int hashcode()const;
      pkm_uint size()const;
      void read(PacketBuffer&);
      void write(PacketBuffer&)const;
  ...
  private:
      ...
      pkm_byte source;
  public:
      constexpr static pkm_byte id = 3;
      CPacketAction();
